# Module 03 — Latihan 2: Bangun Panel UI Chatbot AI Financial Advisor

> **Urutan**: Ini latihan **kedua** Module 03. Pastikan **[Latihan 1 — Koneksi Pertama Claude API](./latihan.md)** sudah selesai sebelum mulai di sini.

> Latihan ini menyiapkan UI chatbot Fin-App sebagai persiapan integrasi Claude API di **Module 04**. Tidak ada logic AI di sini; semua pure UI/komponen.

> Latihan untuk membangun **panel chatbot sisi kanan** di aplikasi Fin-App. Lima prompt siap copy-paste yang akan menghasilkan UI lengkap — masih tanpa AI logic, siap untuk disambungkan ke Claude API di **Module 04 Section 1**.
>
...
- [ ] Anda sudah menyelesaikan latihan inti Module 03 (koneksi pertama ke Claude API).
...
Pastikan checklist berikut tercapai sebelum lanjut ke Module 04:
