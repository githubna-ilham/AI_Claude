...
> **Konteks**: Materi pendamping untuk **[`latihan-2-ui-chatbot.md`](./latihan.md)** — latihan persiapan menuju Module 04.
>
...
Lanjutkan ke [`latihan-2-ui-chatbot.md`](./latihan.md) untuk mulai mengeksekusi prompt-promptnya.
