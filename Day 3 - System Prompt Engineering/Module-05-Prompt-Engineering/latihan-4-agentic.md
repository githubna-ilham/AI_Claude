...
Untuk SETIAP pertanyaan user terkait dengan permintaan pendapat, ikuti workflow berikut:

1. **Information Extraction** — identifikasi terlebih dahulu user untuk mendapatkan informasi:
...
- ❌ Menyembunyikan langkah-langkah workflow dari user — Claude akan mengajukan pertanyaan untuk mengekstrak informasi secara bertahap.
...
- JANGAN implementasi tool use — workflow ini murni via
  prompting.
- Claude mengajukan pertanyaan bertahap ke user untuk
