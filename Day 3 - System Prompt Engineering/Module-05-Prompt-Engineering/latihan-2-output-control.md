...
**Pengecualian**: saat thinking aktif (mode Opus), gunakan `max_tokens: 16000` — thinking token + final answer dihitung bersama, jadi butuh ruang lebih besar.
...
**2. Apabila ada cabang thinking (Opus dengan extended thinking), pertahankan `max_tokens: 16000`**
...
const stream = client.messages.stream({
  ...
  max_tokens: 16000,                     /* ← lebih besar saat thinking aktif */
  thinking: { type: "adaptive" as const },
  output_config: { effort: "medium" },
  system: ADVISOR_SYSTEM,
  messages,
  stop_sequences: ["User:", "AI:", "Disclaimer:", "Sebagai AI,"],
  temperature: 1,                        /* ← thinking wajib temperature: 1 */
});
```
