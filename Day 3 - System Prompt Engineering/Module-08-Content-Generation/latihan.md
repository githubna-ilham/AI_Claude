...
|----|---------|-------|----------|
| 0  | **[Latihan UI Chatbot (Module 03)](../Module-03-UI-Chatbot/latihan.md)** | Layout 3-kolom + panel chatbot statis (5 prompt) — prasyarat | 45–60 menit |
...
🚀 Mulai: **[Latihan UI Chatbot (Module 03)](../Module-03-UI-Chatbot/latihan.md)** — lalu lanjut ke Section 1.
