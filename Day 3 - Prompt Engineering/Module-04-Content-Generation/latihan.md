...
| 1  | **[Integrasi Claude API ke Chatbot](./latihan-integrasi-api.md)** | Server action `askAdvisor` + welcome + error handling (4 prompt) | 40–50 menit |
| 2  | **[Text Generation](./latihan-text-generation.md)** | `temperature`, `max_tokens`, prompt prefixing (4 prompt) | 35–45 menit |
| 3  | **[Thinking / Thought](./latihan-thinking.md)** | Extended thinking + collapsible UI (4 prompt) | 40–50 menit |
| 4  | **[Switching Thinking Mode](./latihan-switching-thinking.md)** | Toggle thinking + budget low/medium/high (4 prompt) | 30–40 menit |
| 5  | **[Streaming Process](./latihan-streaming.md)** | Route handler streaming + client consume `ReadableStream` (3 prompt) | 50–60 menit |
| 6  | **[Multi-Turn Conversation](./latihan-multi-turn.md)** | Kirim riwayat percakapan + reset (3 prompt) | 30–40 menit |

---

## Urutan yang Disarankan

Kerjakan section secara berurutan — tiap section mengandalkan output section sebelumnya. Setelah selesai semua, kembali ke akhir **[Section 6](./latihan-multi-turn.md#-validasi-akhir-module-04-seluruh-6-section)** untuk **Validasi Akhir Module 04**.
