...
> Bagian dari **[Module 04 — Latihan](./latihan.md)**. Lanjutan dari **[Section 6](./latihan-section-6.md)**.
...
>
> **Estimasi Section 7**: 30–40 menit.

## Prasyarat Section 7

- [ ] Section 1–6 selesai. Streaming bekerja dengan toggle thinking.
- [ ] Anda sudah membaca bagian Section 7 di `materi.md`.
...
- INSTRUCTION_PREFIX (dari Section 3) dipasang di pesan user
  TERAKHIR sebelum dikirim ke API — bukan di setiap pesan
  user di riwayat.

GUARDRAIL:
- JANGAN ubah behaviour streaming dari Section 6 — hanya
  ubah input format.
- Validasi role: setiap pesan harus role "user" atau
  "assistant" (bukan "system").
- Welcome message dari Section 2 TIDAK perlu dikirim ke API
...
- Pertahankan streaming behaviour Section 6 sepenuhnya.
```
...
## Validasi Akhir Section 7 (Akhir Module 04)
...
## 🎉 Validasi Akhir Module 04 (Seluruh 7 Section)
...
⬅️ Kembali: **[Section 6](./latihan-section-6.md)** · 🏠 Index: **[Module 04 — Latihan](./latihan.md)**
