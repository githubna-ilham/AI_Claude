# Latihan UI — Bangun Panel Chatbot AI Financial Advisor

> Latihan tambahan untuk **Module 03** — menyiapkan UI chatbot Fin-App sebagai persiapan integrasi Claude API di **Module 04**. Tidak ada logic AI di sini; semua pure UI/komponen.
